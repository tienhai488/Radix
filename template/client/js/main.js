...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    $(".service-slider").slick({
      ...
      draggable: true,
      prevArrow:
        '<button class="Prev"><i class="fa fa-long-arrow-alt-left" aria-hidden="true"></i></button>',
      nextArrow:
        '<button class="Next"><i class="fa fa-long-arrow-alt-right" aria-hidden="true"></i></button>',
      responsive: [
        {
          breakpoint: 800,
          settings: {
