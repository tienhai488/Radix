...
if (isGet()) {
    $data = getValueOptions("general_service");
    echo $data;
    if (empty($data)) {
        $data = [];
    } else {
...
if (isPost()) {
    ...
    $result = update("options", $dataUpdate ,'opt_key = "general_service"');
    if ($result) {
        setFlashData("msg", "Thiết lập dịch vụ thành công!");
        setFlashData("msg_type", "success");
    } else {
        setFlashData("msg", "Thiết lập dịch vụ không thành công!");
...
<div style="max-width: 1200px;margin:0 auto; ">
    ...
    <form action="" method="POST">
        <div class="row">
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="text" name="text_bg" placeholder="Tiêu đề nền..." class="form-control" value="<?php getValueInput(
                        $data,
                        "text_bg"
                    ); ?>">
        ...
        <h3>Trang Service</h3>
        <div class="form-group">
            <label for="">Tiêu đề trang Service</label>
            <div class="form-group">
                <input class="form-control" placeholder="Tiêu đề trang Service..." type="text" name="title_service"
        ...
        <button type="submit" class="btn btn-primary">Thiết lập Service</button>
