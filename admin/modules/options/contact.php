...
if (isPost()) {
    ...
    if ($result) {
        setFlashData("msg", "Thiết lập contact thành công!");
        setFlashData("msg_type", "success");
    } else {
        setFlashData("msg", "Thiết lập contact không thành công!");
...
<div style="max-width: 1200px;margin:0 auto; ">
    ...
    <form action="" method="POST">
        ...
        <h3>Trang Contact</h3>
        <div class="form-group">
            <label for="">Tiêu đề trang contact</label>
            <div class="form-group">
                <input class="form-control" placeholder="Tiêu đề trang Contact..." type="text" name="title_contact"
